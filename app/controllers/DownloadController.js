    ...
    try {
      ...
      res.render('download/success', {
        ...
        grades: validRows.map(r => ({
          ...
          label: r.label,
          // Chỉ trả link nếu có URL VÀ không bị ẩn
          url_main:      (!r.hidden_main    && r.url_main)    ? r.url_main    : null,
          label_main:    r.label_main,
          url_mirror1:   (!r.hidden_mirror1 && r.url_mirror1) ? r.url_mirror1 : null,
          label_mirror1: r.label_mirror1,
          url_mirror2:   (!r.hidden_mirror2 && r.url_mirror2) ? r.url_mirror2 : null,
          label_mirror2: r.label_mirror2,
          url_mirror3:   (!r.hidden_mirror3 && r.url_mirror3) ? r.url_mirror3 : null,
